			...
			return this.each(function() {
				...
				if (!e.data("isActive")) {
					...
					da = function() {
						...
						k = G / 2;
						h = "";
						"single" === a.type ? (h = f.fromNumber === a.max ? a.maxPostfix: "", A[0].style.display = "none", B[0].style.display = "none", h = I ? a.prefix + a.values[f.fromNumber] + h + a.postfix: a.prefix + z(f.fromNumber) + h + a.postfix, w.html(h), g = w.outerWidth(!1), k = f.fromX - g / 2 + k, 0 > k && (k = 0), k > t - g && (k = t - g), w[0].style.left = k + "px", a.hideMinMax || a.hideFromTo || (D[0].style.display = k < Q ? "block": "block", E[0].style.display = k + g > t - R ? "block": "block"), e.prop("value", parseFloat(f.fromNumber))) : "double" === a.type && (h = f.toNumber === a.max ? a.maxPostfix: "", I ? (b = a.prefix + a.values[f.fromNumber] + a.postfix, d = a.prefix + a.values[f.toNumber] + h + a.postfix, h = f.fromNumber !== f.toNumber ? a.prefix + a.values[f.fromNumber] + " \u2014 " + a.prefix + a.values[f.toNumber] + h + a.postfix: a.prefix + a.values[f.fromNumber] + h + a.postfix) : (b = a.prefix + z(f.fromNumber) + a.postfix, d = a.prefix + z(f.toNumber) + h + a.postfix, h = f.fromNumber !== f.toNumber ? a.prefix + z(f.fromNumber) + " \u2014 " + a.prefix + z(f.toNumber) + h + a.postfix: a.prefix + z(f.fromNumber) + h + a.postfix), A.html(b), B.html(d), w.html(h), b = A.outerWidth(!1), d = f.fromX - b / 2 + k, 0 > d && (d = 0), d > t - b && (d = t - b), A[0].style.left = d + "px", h = B.outerWidth(!1), c = f.toX - h / 2 + k, 0 > c && (c = 0), c > t - h && (c = t - h), B[0].style.left = c + "px", g = w.outerWidth(!1), k = f.fromX + (f.toX - f.fromX) / 2 - g / 2 + k, 0 > k && (k = 0), k > t - g && (k = t - g), w[0].style.left = k + "px", d + b < c ? (w[0].style.display = "block", A[0].style.display = "none", B[0].style.display = "none") : (w[0].style.display = "block", A[0].style.display = "block", B[0].style.display = "block"), a.hideMinMax || a.hideFromTo || (D[0].style.display = k < Q || d < Q ? "block": "none", E[0].style.display = k + g > t - R || c + h > t - R ? "display": "none"), e.prop("value", parseFloat(f.fromNumber) + ";" + parseFloat(f.toNumber)));
						a.from = f.fromNumber;
						a.to = f.toNumber;
						ja()
					},
					...
					ia = function() {
						...
						u ? (d = a.min + (a.max - a.min) / 10 * b, d = d / a.step * a.step, d = parseInt(d * u, 10) / u) : (d = Math.round(a.min + (a.max - a.min) / 10 * b), d = Math.round(d / a.step) * a.step, d = z(d)),
						I && (a.hideMinMax ? (d = Math.round(a.min + (a.max - a.min) / 10 * b), d = Math.round(d / a.step) * a.step, d = 0 === b || 10 === b ? a.values[d] : "") : d = ""),
						0 === b ? e += '<span class="irs-grid-text" style="left: ' + c + 'px; text-align: left;">' + d+"万" + "</span>": 10 === b ? (c -= 100, e += '<span class="irs-grid-text" style="left: ' + c + 'px; text-align: right;">' + d+"万" + "</span>") : (c -= 50, e += '<span class="irs-grid-text" style="left: ' + c + 'px;">' + d+"万" + "</span>");
						Y.html(e);
